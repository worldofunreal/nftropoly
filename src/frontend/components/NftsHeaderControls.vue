<template>
  <div class="flex flex-wrap gap-2 items-center mb-4">
    ...
    <div class="flex gap-1 ml-auto">
      <button @click="view = 'grid'" :class="view === 'grid' ? 'bg-primary-600 text-white' : 'bg-gray-800 text-gray-200'" class="p-2 rounded"><UIcon name="i-heroicons-squares-2x2-20-solid" /></button>
      <button @click="view = 'list'" :class="view === 'list' ? 'bg-primary-600 text-white' : 'bg-gray-800 text-gray-200'" class="p-2 rounded"><UIcon name="i-heroicons-bars-3-20-solid" /></button>
    </div>
  </div>
</template>
