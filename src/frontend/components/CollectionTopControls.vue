<template>
  <div class="flex flex-wrap gap-2 items-center">
    ...
    <div class="flex gap-1 ml-2">
      ...
      <button @click="view = 'list'" :class="view === 'list' ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-500'" class="px-3 py-2 rounded-r font-bold">List</button>
    </div>
