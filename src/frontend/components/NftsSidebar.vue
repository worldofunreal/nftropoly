  ...
  <div class="flex flex-col gap-6">
    ...
    >
      <div class="flex flex-wrap gap-2 mt-2">
        <button
          ...
          :class="selectedCategory === cat ? 'bg-primary-600 text-white border-primary-600' : 'bg-neutral-100 dark:bg-neutral-800 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-700'"
    ...
    >
      ...
      <div class="flex flex-wrap gap-2">
        <button
          ...
          :class="selectedChain === chain.label ? 'bg-primary-600 text-white border-primary-600' : 'bg-neutral-100 dark:bg-neutral-800 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-700'"
    ...
    >
      <div class="flex flex-col gap-2 items-center mb-2 mt-2">
        <select class="px-2 py-1 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-800 text-gray-700 dark:text-gray-200 w-full">
          <option>ETH</option>
        </select>
        <div class="flex gap-2 items-center w-full">
          <input type="number" placeholder="Min" class="w-16 px-2 py-1 flex-1 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-800 text-gray-700 dark:text-gray-200" />
          <span class="text-gray-500 dark:text-gray-400">to</span>
          <input type="number" placeholder="Max" class="w-16 px-2 py-1 flex-1 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-800 text-gray-700 dark:text-gray-200" />
        </div>
    ...
    >
      <div class="flex flex-col gap-2 items-center mb-2 mt-2">
        <select class="px-2 py-1 flex-1 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-800 text-gray-700 dark:text-gray-200 w-full">
          <option>WETH</option>
        </select>
        <div class="flex gap-2 items-center w-full">
          <input type="number" placeholder="Min" class="w-16 px-2 py-1 flex-1 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-800 text-gray-700 dark:text-gray-200" />
...
const openSections = reactive({ category: true, chains: false, floorPrice: false, topOffer: false })
const categories = [
  "All",
  "Art",
  "Gaming",
