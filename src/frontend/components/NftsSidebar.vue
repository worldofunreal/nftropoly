  ...
  <div class="flex flex-col gap-6">
    ...
    <div>
      ...
      <input
        ...
        class="w-full px-3 py-2 rounded border border-gray-700 bg-gray-800 text-gray-200 mb-2"
      />
      <div class="flex flex-wrap gap-2">
        <button
    ...
    <div>
      ...
      <div class="flex gap-2 flex-col items-center mb-2">
        <select
          class="px-2 py-1 rounded border border-gray-700 bg-gray-800 text-gray-200 w-full"
        >
          <option>ETH</option>
        </select>
        <div class="flex gap-2 items-center w-full">
          <input
            type="number"
            placeholder="Min"
            class="w-16 px-2 py-1 flex-1 rounded border border-gray-700 bg-gray-800 text-gray-200"
          />
        ...
        <button
          class="px-3 py-1 rounded bg-primary-600 text-white w-full"
        >
          Apply
        </button>
      </div>
    ...
    <div>
      ...
      <div class="flex gap-2 flex-col items-center mb-2">
        <select
          class="px-2 py-1 flex-1 rounded border border-gray-700 bg-gray-800 text-gray-200 w-full"
        >
          <option>WETH</option>
        </select>
        <div class="flex gap-2 items-center w-full">
