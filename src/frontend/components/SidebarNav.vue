<template>
  <aside
    class="z-100 fixed top-0 left-0 h-screen z-40 flex flex-col bg-white dark:bg-neutral-950/90 border-r border-gray-200 dark:border-gray-800 overflow-hidden group"
