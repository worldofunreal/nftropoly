    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-6">
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-wrap gap-2">
          <button
            ...
            :class="selectedStatuses.includes(status) ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200'"
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-col gap-2">
          <label v-for="m in marketplaces" :key="m" class="flex items-center gap-2">
            <input type="checkbox" v-model="selectedMarketplaces" :value="m" class="accent-primary-600 w-5 h-5" />
            <span class="text-gray-700 dark:text-gray-200 font-medium">{{ m }}</span>
          </label>
        </div>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-wrap gap-2">
          <button
            ...
            :class="selectedChains.includes(chain.label) ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200'"
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-col gap-1 max-h-40 overflow-y-auto">
          ...
          >
            <input type="checkbox" v-model="selectedCollections" :value="col.name" class="accent-primary-600 w-5 h-5" />
            <span>{{ col.name }}</span>
...
// Filter states
const statuses = [
  "All", "Sale", "Mint", "Transfer", "Listing", "Item Offer", "Collection Offer", "Trait Offer"
]
