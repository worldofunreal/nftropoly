<template>
  <div class="w-[220px] max-w-[260px] p-4 bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800">
    ...
    >
      <input type="text" placeholder="Search chains..." class="w-full px-3 py-2 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 mb-2 mt-2" />
    ...
    >
      <input type="text" placeholder="Search collections..." class="w-full px-3 py-2 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 mb-2 mt-2" />
    </SidebarSection>
  </div>
</template>
