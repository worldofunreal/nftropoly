<template>
  <div class="flex flex-col gap-4 p-4 w-full">
    ...
    <div class="md:hidden flex items-center justify-between mb-4">
      <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Created</h2>
      <button 
        ...
        <tbody>
          <tr v-for="col in collections" :key="col.id" class="border-b border-gray-200 dark:border-gray-800 hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-colors">
            ...
            <td class="p-4 text-right whitespace-nowrap">
              <span class="font-medium text-gray-900 dark:text-white">{{ col.floorPrice }}</span>
            </td>
            <td class="p-4 text-right whitespace-nowrap">
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <select class="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-950">
              <option>Floor Price: High to Low</option>
              <option>Floor Price: Low to High</option>
          ...
          <div>
            ...
            <div class="space-y-2">
              <label class="flex items-center gap-3">
                ...
                <span class="text-sm text-gray-700 dark:text-gray-300">Active Collections</span>
              </label>
              <label class="flex items-center gap-3">
                <input type="checkbox" class="rounded border-gray-300 dark:border-gray-600" />
                <span class="text-sm text-gray-700 dark:text-gray-300">Paused Collections</span>
              </label>
              <label class="flex items-center gap-3">
                <input type="checkbox" class="rounded border-gray-300 dark:border-gray-600" />
                <span class="text-sm text-gray-700 dark:text-gray-300">Draft Collections</span>
              </label>
            </div>
          </div>
        </div>
