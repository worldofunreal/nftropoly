  ...
  <div class="w-[220px] max-w-[260px] p-4 bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800">
    ...
    >
      <div class="flex flex-wrap gap-2 mt-2">
        <button v-for="cap in marketCaps" :key="cap" class="px-3 py-1 rounded-full border text-xs font-semibold bg-white dark:bg-gray-950 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-700">{{ cap }}</button>
      </div>
    </SidebarSection>
    <SidebarSection
      title="Category"
