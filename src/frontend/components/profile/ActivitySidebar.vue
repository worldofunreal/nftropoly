  ...
  <div class="w-[220px] max-w-[260px] p-4 bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800">
    ...
    >
      <div class="flex flex-col gap-2 mt-2">
        <label v-for="mp in marketplaces" :key="mp" class="flex items-center gap-2">
          <input type="checkbox" v-model="selectedMarketplaces" :value="mp" class="form-checkbox rounded" /> {{ mp }}
        </label>
      </div>
    </SidebarSection>
    <SidebarSection
...
const openSections = reactive({ status: true, marketplaces: false, chains: false, collections: false })
