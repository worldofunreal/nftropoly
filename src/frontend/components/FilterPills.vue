<template>
  <div class="flex items-center gap-2 overflow-x-auto scrollbar-hide">
    ...
    <!-- Stats Icon Button -->
    <button class="ml-2 flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 hover:bg-primary-50 dark:hover:bg-primary-900 transition">
