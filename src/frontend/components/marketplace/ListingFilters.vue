<template>
  <div class="bg-white rounded-lg shadow-sm border p-6">
    ...
    <div class="space-y-6">
      ...
      <!-- Price Range -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">Price Range (NTRP)</label>
      ...
      <div>
        ...
        <div class="space-y-2">
          <label v-for="tokenType in tokenTypeOptions" :key="tokenType.value" class="flex items-center">
            <input
              ...
              class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
            />
            <span class="ml-2 text-sm text-gray-700">{{ tokenType.label }}</span>
          </label>
        </div>
      </div>
