  ...
  <div class="bg-gray-900 rounded-lg p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div class="flex space-x-6">
        <button
          class="text-white font-semibold border-b-2 border-blue-500 pb-2"
        >
          Swap
        </button>
        <button
    ...
    <!-- Sell Section -->
    <div class="space-y-3">
      <label class="text-sm font-medium text-gray-300">Sell</label>
      <div class="space-y-2">
        <UInput
          v-model="sellAmount"
          type="number"
          ...
          class="text-right"
        />
        <div class="text-sm text-gray-400 text-right">$0.00</div>
        <div class="flex items-center justify-between">
          <UButton
            variant="outline"
            color="neutral"
          ...
          <div class="text-sm text-gray-400">
            <span>0.00 ETH</span>
            <UButton variant="ghost" color="primary" size="xs" class="ml-2">
              Max
            </UButton>
          </div>
        </div>
    ...
    <!-- Buy Section -->
    <div class="space-y-3">
      <label class="text-sm font-medium text-gray-300">Buy</label>
      <div class="space-y-2">
        <UInput
          v-model="buyAmount"
          type="number"
