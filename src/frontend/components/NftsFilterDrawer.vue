    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-6">
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-wrap gap-2">
          <button
            ...
            :class="selectedTab === tab ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200'"
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-wrap gap-2">
          <button
            ...
            :class="selectedCategory === cat ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200'"
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-wrap gap-2">
          <button
            ...
            :class="selectedChain === chain.label ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200'"
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-col gap-3">
          <select class="w-full px-3 py-2 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200">
            <option>ETH</option>
          </select>
          <div class="flex gap-2 items-center">
            <input type="number" placeholder="Min" class="flex-1 min-w-0 px-3 py-2 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200" />
            <span class="text-gray-500 dark:text-gray-400">to</span>
            <input type="number" placeholder="Max" class="flex-1 min-w-0 px-3 py-2 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200" />
          </div>
          <button class="w-full px-3 py-2 rounded bg-primary-600 text-white font-medium">Apply</button>
        </div>
      </div>
      ...
      <div class="flex items-center gap-3">
        <input
          ...
          v-model="isVerified"
        />
        <label for="mobile-is-verified" class="text-gray-700 dark:text-gray-200 font-medium">Is Verified</label>
      </div>
    </div>
...
const categories = [
  "All", "Art", "Gaming", "Memberships", "Music", "PFPs", 
  "Photography", "Domain Names", "Sports Collectibles", "Virtual Worlds"
]
