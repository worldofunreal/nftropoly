  ...
  <div class="bg-neutral-800 rounded-lg">
    ...
    <div class="flex items-center justify-between p-4 border-b border-gray-700">
      <div class="flex items-center gap-2">
        <UIcon name="i-heroicons-currency-dollar-20-solid" class="text-primary-500" />
      ...
      <div class="relative h-64 bg-neutral-900 rounded-lg p-4">
        ...
        <div class="ml-12 h-full relative">
          ...
          <div class="absolute inset-0 grid grid-rows-5">
            <div v-for="i in 5" :key="i" class="border-b border-gray-700"></div>
          </div>
          ...
          <div class="absolute top-2 right-2 bg-primary-500 text-white px-2 py-1 rounded text-sm font-bold">
            Current: 47.50 ETH
          </div>
        </div>
