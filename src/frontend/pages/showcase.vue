  ...
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-950">
    <UContainer>
      ...
      <div class="py-8 pt-32">
          <h1 class="text-4xl md:text-5xl font-extrabold mb-10 text-center text-gray-900 dark:text-white tracking-tight">
            Into the Metaverse
          </h1>
          <p class="text-xl text-gray-600 text-center dark:text-gray-500 max-w-3xl mx-auto">
            ...
            >
              ...
              <div class="relative h-48 overflow-hidden">
                ...
                <div class="absolute bottom-4 left-4">
                  <span class="bg-primary-600 text-white px-3 py-1 rounded-full text-xs font-bold uppercase">
                    {{ project.category }}
                  </span>
                </div>
              </div>
              ...
              <div class="p-6">
                ...
                >
                  ...
                  >
                    {{ project.action }}
                    <UIcon name="i-fa6-solid-arrow-right" class="ml-2 group-hover:translate-x-1 transition-transform" />
                  </UButton>
                </a>
              </div>
            </UCard>
...
const projects = [
  {
    ...
    description: 'A Metaverse gaming franchise with video games, NFTs, and a growing lore. Play, own, and explore.',
  ...
  },
  {
    ...
    description: 'True decentralized marketplace under construction, multichain with AI tools for creators and analytics.',
  ...
  },
  {
    ...
    name: 'IC Hub',
    category: 'Web3 App',
    description: 'Decentralized social media platform, a gateway to the world of Web3 Apps.',
  ...
  },
  {
    ...
    description: 'AI-powered productivity app that helps you master the signal-to-noise ratio for peak performance.',
  ...
  },
  {
    ...
    name: 'Hyper',
    category: 'Launcher',
    description: 'Launcher for apps made with Electron. Features a self-updater and app launching.',
...
const filteredProjects = computed(() => {
  ...
  if (selectedTag.value !== 'All') {
    filtered = filtered.filter(p => p.tech && p.tech.includes(selectedTag.value))
  }
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Explore our showcase of Web3 games, GameFi projects, blockchain apps, and AI-powered CGI art. Discover the future of game development, NFTs, and the Metaverse.' },
    { name: 'keywords', content: 'Web3 gaming, GameFi, game development, Metaverse, NFTs, blockchain, AI, CGI, open source, vibe coding' },
    { property: 'og:title', content: 'Showcase – Web3 Gaming, GameFi, Blockchain | World of Unreal' },
    { property: 'og:description', content: 'Explore our showcase of Web3 games, GameFi projects, blockchain apps, and AI-powered CGI art. Discover the future of game development, NFTs, and the Metaverse.' },
    { property: 'og:type', content: 'website' },
    { property: 'og:url', content: 'https://worldofunreal.com/showcase' },
    { property: 'og:image', content: '/logo_full.svg' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:title', content: 'Showcase – Web3 Gaming, GameFi, Blockchain | World of Unreal' },
    { name: 'twitter:description', content: 'Explore our showcase of Web3 games, GameFi projects, blockchain apps, and AI-powered CGI art. Discover the future of game development, NFTs, and the Metaverse.' },
    { name: 'twitter:image', content: '/logo_full.svg' }
  ],
  link: [
    { rel: 'canonical', href: 'https://worldofunreal.com/showcase' }
  ],
  script: [
    {
