<template>
  <div>
    <div class="flex min-h-screen bg-neutral-50 dark:bg-neutral-950">
      <!-- Sidebar (Left Panel) - Hidden on mobile -->
      <aside class="hidden md:block w-80 p-4 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-neutral-950">
        <NftsSidebar />
      </aside>
      <!-- Main Table (Right Panel) -->
      <div class="flex-1 flex flex-col min-h-screen overflow-hidden bg-white dark:bg-neutral-950">
        <!-- Header Controls - Hidden on mobile -->
        <div class="hidden md:block p-4 flex-shrink-0 bg-white dark:bg-neutral-950">
          <NftsHeaderControls />
        </div>
