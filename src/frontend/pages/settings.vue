  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">Manage your account preferences and security settings</p>
      </div>
        ...
        <div class="p-6">
          ...
          <div v-if="activeTab === 'profile'" class="space-y-6">
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update your personal information and profile picture</p>
            </div>
            
            <div class="flex items-center space-x-6">
              <div class="flex-shrink-0">
                <img class="h-16 w-16 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Profile" />
              </div>
              <div>
                <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                  Change Photo
                </button>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">JPG, GIF or PNG. 1MB max.</p>
              </div>
            </div>
          ...
          <div v-if="activeTab === 'notifications'" class="space-y-6">
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Choose how you want to be notified about activity</p>
            </div>
