    ...
    meta: [
      {
        ...
        content: computed(() =>
          userProfile.value
            ? profileBio.value ||
              `View ${profileDisplayName.value}'s NFT collection, tokens, and activity on Nftropoly - The Multichain, Gasless NFT Marketplace`
      ...
      },
      {
        ...
        content: computed(() =>
          userProfile.value
            ? profileBio.value ||
              `View ${profileDisplayName.value}'s NFT collection, tokens, and activity on Nftropoly`
            : 'Profile not found on Nftropoly'
        ),
      },
      {
