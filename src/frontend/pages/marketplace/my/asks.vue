    ...
    <div class="bg-white shadow-sm border-b">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-6">
          ...
          <UButton to="/marketplace/create" icon="i-heroicons-plus" size="lg">
            Create Listing
          </UButton>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-sm border">
        ...
        <div class="p-6">
          ...
          <div v-else-if="userAsksError" class="text-center py-12">
            ...
            <UButton variant="outline" @click="loadUserAsks">
              Try Again
            </UButton>
          </div>
...
<script setup lang="ts">
  ...
  const totalParticipants = computed(() => {
    return userAsks.value.reduce(
      (total, ask) => total + ask.participants.length,
      0
    )
  })
