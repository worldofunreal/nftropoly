  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-if="loading" class="space-y-6">
        <div class="bg-white rounded-lg shadow-sm border p-6 animate-pulse">
          <div class="flex space-x-6">
            <div class="w-80 h-80 bg-gray-200 rounded-lg" />
      ...
      <div v-else-if="error" class="text-center py-12">
        ...
        <UButton variant="outline" @click="loadAskDetails"> Try Again </UButton>
      </div>
      ...
      <div v-else-if="!ask" class="text-center py-12">
        ...
        <UButton to="/marketplace" variant="outline"> Browse Listings </UButton>
      </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
              <div class="flex space-x-6">
                <div
                  class="w-80 h-80 bg-gray-100 rounded-lg flex items-center justify-center"
                >
                  <UIcon
            ...
            >
              ...
              <DutchPriceChart :ask="ask" class="mb-4" />
              <div class="text-sm text-gray-600">
                Price decreases over time until someone purchases or the auction
                ends.
              </div>
            </div>
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div class="space-y-3">
                ...
                <div v-if="ask.settled_at" class="flex justify-between">
                  ...
                  <span class="text-sm font-medium text-gray-900">{{
                    formatTimestamp(ask.settled_at[0][1])
                  }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div class="space-y-3">
                <div
                  v-for="participant in ask.participants.slice(0, 5)"
                  :key="participant.owner.toString()"
...
<script setup lang="ts">
  ...
  const handleBuyNow = async () => {
    ...
    try {
                ...
                [
                  {
                    ...
                    canister: 'uzt4z-lp777-77774-qaabq-cai' as unknown,
                    symbol: 'NTRP',
                  },
                ],
              ],
            },
            buyer: [{ owner: currentUser.value as unknown, subaccount: [] }],
      ...
      error.value =
        err instanceof Error ? err.message : 'Failed to purchase NFT'
    } finally {
      buying.value = false
    }
  }
                ...
                [
                  {
                    standards: [
                      {
                        ICRC1: [
                          { amount: bidAmount, fee: [], decimals: BigInt(8) },
                        ],
                      },
                    ],
                    canister: 'uzt4z-lp777-77774-qaabq-cai' as unknown,
  ...
  const getPriceToken = (_ask: AskStatus) => {
    return 'NTRP'
  }
