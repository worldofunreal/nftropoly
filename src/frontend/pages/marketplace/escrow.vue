        ...
        <div class="flex justify-between items-center py-6">
          <div>
            ...
            <p class="mt-2 text-gray-600">
              Manage your escrowed assets and settlements
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mt-6">
        ...
        <div v-else-if="error" class="text-center py-12">
          ...
          <UButton variant="outline" @click="loadBalances"> Try Again </UButton>
        </div>
    ...
    switch (activeTab.value) {
      ...
      case 'nfts':
        return 'Nfts' in balance && balance.Nfts[0]
          ? balance.Nfts[0].records
          : []
      case 'tokens':
        return 'Tokens' in balance && balance.Tokens[0]
          ? [{ amount: balance.Tokens[0] }]
          : []
      default:
        return []
    }
