...
<template>
  <UContainer class="py-20 max-w-3xl mx-auto">
    <article v-if="post">
      ...
      <img v-if="post.image" :src="post.image" :alt="`${post.title} – ${post.category} | AI, Web3, Open Source, Blockchain, NFTs, CGI, AI Art`" class="mb-8 rounded-lg w-full max-h-96 object-cover" />
