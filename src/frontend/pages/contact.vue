  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center py-16 px-4 pt-32">
    <div class="w-full max-w-5xl mx-auto flex flex-col md:flex-row gap-10 items-stretch justify-center min-h-[70vh]">
      ...
      <div class="flex-1 flex flex-col justify-center mb-8 md:mb-0 md:pr-8 items-center md:items-start text-center md:text-left">
        <div class="mb-6 flex flex-col items-center md:items-start gap-6 w-full">
          <img :src="logoSrc" alt="World of Unreal Logo" class="h-12 md:h-16 w-auto mx-auto md:mx-0" />
          <div class="w-full">
            <p class="uppercase tracking-widest text-xs text-gray-500 dark:text-gray-400 font-semibold mb-2">We're here to help you</p>
            <h1 class="text-3xl md:text-4xl font-black text-gray-800 dark:text-white mb-4 leading-tight">
              Say Hi! <span class="text-primary-600 dark:text-primary-400">and tell us about your ideas.</span>
            </h1>
            <p class="text-gray-600 dark:text-gray-300 mb-6">Are you looking for top-quality development, AI agents, or Web3 solutions tailored to your needs? Reach out to us.</p>
          </div>
        </div>
        <div class="flex flex-col gap-4 text-base items-center md:items-start">
          <div class="flex items-center gap-3">
            <UIcon name="i-fa6-solid-envelope" class="text-primary-600 dark:text-primary-400 text-xl" />
            <span class="font-medium">contact@worldofunreal.com</span>
          </div>
          <div class="flex items-center gap-3 mt-2">
            <a href="https://x.com/worldofunreal" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary transition-colors text-xl" aria-label="Twitter">
              <UIcon name="i-fa6-brands-twitter" />
            </a>
            <a href="https://github.com/worldofunreal" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary transition-colors text-xl" aria-label="GitHub">
              <UIcon name="i-fa6-brands-github" />
            </a>
            <a href="https://www.linkedin.com/company/worldofunreal/" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary transition-colors text-xl" aria-label="LinkedIn">
