...
export const useMarketplace = () => {
  ...
  // Load active asks
  const loadActiveAsks = async (pagination?: { prev?: bigint; take?: bigint }) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to load active asks'
  ...
  const loadAskDetails = async (askId: string) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to load ask details'
  ...
  const loadUserAsks = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to load user asks'
  ...
  const loadUserBids = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to load user bids'
  ...
  const loadBalances = async (account: Account, requests: BalanceRequest[]) => {
    ...
    try {
      ...
      const response = await marketplaceService.getBalanceOf([[account, requests]])
  ...
  const createAsk = async (features: AskFeature[]) => {
    ...
    try {
      ...
      if (response && isSuccessResponse(response)) {
        ...
        const errorMessage = response ? getResponseError(response) : 'Failed to create ask'
        error.value = errorMessage
        return null
      }
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : 'Failed to create ask'
      error.value = errorMessage
      return null
    } finally {
      loading.value = false
  ...
  const endAsk = async (askId: bigint) => {
    ...
    try {
      ...
      if (response && isSuccessResponse(response)) {
        ...
        const errorMessage = response ? getResponseError(response) : 'Failed to end ask'
        error.value = errorMessage
        return null
      }
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : 'Failed to end ask'
      error.value = errorMessage
      return null
    } finally {
      loading.value = false
  ...
  const createBid = async (askId: bigint, features: BidFeature[]) => {
    ...
    try {
      ...
      if (response && isSuccessResponse(response)) {
        ...
        const errorMessage = response ? getResponseError(response) : 'Failed to create bid'
        error.value = errorMessage
        return null
      }
    } catch (err) {
  ...
  // Withdraw escrow
  const withdrawEscrow = async (escrowRecord: any) => {
    if (!isAuthenticated.value) return null
    ...
    try {
      ...
      if (response && isSuccessResponse(response)) {
        ...
        const errorMessage = response ? getResponseError(response) : 'Failed to withdraw escrow'
        error.value = errorMessage
        return null
      }
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : 'Failed to withdraw escrow'
      error.value = errorMessage
      return null
    } finally {
      loading.value = false
  ...
  // Withdraw settlement
  const withdrawSettlement = async (escrowRecord: any) => {
    if (!isAuthenticated.value) return null
    ...
    try {
      ...
      if (response && isSuccessResponse(response)) {
        ...
        const errorMessage = response ? getResponseError(response) : 'Failed to withdraw settlement'
        error.value = errorMessage
        return null
      }
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : 'Failed to withdraw settlement'
      error.value = errorMessage
      return null
    } finally {
      loading.value = false
  ...
  const refreshOffers = async (account?: Account) => {
    ...
    try {
      ...
      if (response && isSuccessResponse(response)) {
        ...
        const errorMessage = response ? getResponseError(response) : 'Failed to refresh offers'
        error.value = errorMessage
        return null
      }
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : 'Failed to refresh offers'
      error.value = errorMessage
      return null
    } finally {
      loading.value = false
  ...
  const distributeAsk = async (askId: bigint) => {
    ...
    try {
      ...
      if (response && isSuccessResponse(response)) {
        ...
        const errorMessage = response ? getResponseError(response) : 'Failed to distribute ask'
        error.value = errorMessage
        return null
      }
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : 'Failed to distribute ask'
      error.value = errorMessage
      return null
    } finally {
      loading.value = false
